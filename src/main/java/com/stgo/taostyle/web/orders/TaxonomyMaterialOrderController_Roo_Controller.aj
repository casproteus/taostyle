...
import com.stgo.taostyle.web.orders.TaxonomyMaterialOrderController;
...
privileged aspect TaxonomyMaterialOrderController_Roo_Controller {
    
        
        
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String TaxonomyMaterialOrderController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void TaxonomyMaterialOrderController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    String TaxonomyMaterialOrderController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
