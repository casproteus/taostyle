...
public class RefreshNoticeCenter {
	...
	private static final HashMap<String, CopyOnWriteArraySet<RefreshNoticeCenter>> connectionPoolMap = new HashMap<String, CopyOnWriteArraySet<RefreshNoticeCenter>>();
	...
	public static void broadcast(String msg, String personId) {
